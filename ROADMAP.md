...
2. **Core Methodology** — the platform-independent workflow, steps, and principles in `core/`. **In progress** — candidate, search criteria, company, person, activity, and research state data model defined.
