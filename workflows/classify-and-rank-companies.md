...
3. For Included and Needs Review companies, apply the [Company Ranking Model](../ranking/company-ranking-model.md) across all eight dimensions, producing a score and Priority tier (or a labeled provisional score for Needs Review).
